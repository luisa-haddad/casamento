        ...
        <div className="teste">
          ...
          <div id="confirmar" className="container">
            ...
            <div className="text">
              ...
              <p>Por favor confirmem a sua presença até <strong>01/10</strong> preenchendo os campos abaixo. Assim que vocês confirmarem o seu nome lindo aparecerá na lista de presença no final dessa página.</p>
              <div>
                <input
                  type="text"
          ...
          <div id="onde" className="container">
            ...
            <div className="text">
              ...
              <p>Para Juquitiba, fica uns 76 Km de SP.<br/><a href="https://waze.com/ul?q=Estrada%20Martha%20Maria%20de%20Jesus,%209500">Estrada Martha Maria de Jesus, 9500</a></p>
            </div>
          </div>
