...
class App extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div className="teste">
          <h1>19/10/2019<br/>A partir das 11:00</h1>
          ...
          <div id="onde" className="container">
            ...
            <div className="text">
              ...
              <p>Para Juquitiba, fica uns 76 Km de SP.<br/><a href="https://goo.gl/maps/Vt7f3Q8HPyzjRAjt6">Estrada Martha Maria de Jesus, 9500</a></p>
            </div>
          </div>
